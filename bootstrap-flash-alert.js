...
(function ($) {
    $.alert_ext = {
        ...
        // Balloon template
        tmpl: '<div class="flash alert alert-dismissable ${State}"><div class="flash-header"><div class="icon">${Icon}</div><strong>${Title}</strong></div><div class="universal-questions">${Content}</div><div><a href="review.html"><button class="linkbutton special" type="button" name="button">Continue without Adding>></button></a><a href="review.html"><button id="add-selected" class="linkbutton special" type="button" name="button">Add Selected >></button></a></div></div>',
